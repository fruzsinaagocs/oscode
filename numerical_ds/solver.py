...
class RKWKBSolver(object):
    def __init__(self,w):
        self.legxs6 =(
        numpy.array([-1.0,-0.7650553239294646929,-0.28523151648064509632,0.28523151648064509632,0.7650553239294646929,1.0]))
        self.legws6 =(
        numpy.array([1.0/15.0,0.37847495629784698032,0.55485837703548635302,0.55485837703548635302,0.37847496,1/15]))
        self.legxs5 =(
